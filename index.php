...
<html lang="en">
    <body>
        <div class="image">
            <h2 class="imagetext">Welcome to BHF Event July 2020</h2>
        </div>
        ...
        <div class="container" id="charity">
            <div class="row">
                <div class="col-sm">
                    <img src="./img/charity_home.jpg" alt="Trucks" width="90%" class="image3">
                </div>
        ...
        <div class="team2"
            <div class="container" id="team">
                ...
                <div class="row">
                    <div class="col-sm">
                        <img src="./img/nathan.png" alt="Avatar" class="avatarimg"><br>
                            Nathan7471<br>
                            Event Organisers
                    </div>
                    <div class="col-sm">
                        <img src="./img/vexus.png" alt="Avatar" class="avatarimg"><br>
                            Vexus<br>
                            Event Founder
                    </div>
                    <div class="col-sm">
